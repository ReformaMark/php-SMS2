...
<nav 
    class="z-50 absolute flex justify-between px-5 md:px-40 items-center w-full bg-white py-5 shadow-sm"
            ...
            <!-- Notifications Dropdown -->
                <div class="relative">
                    <button 
                        ...
                        "
                        onmouseover="this.style.backgroundColor='rgb(243, 244, 246)'; this.style.color='black';"

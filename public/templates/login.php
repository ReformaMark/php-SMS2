<section class="w-1/3 bg-white p-10 rounded-lg outline-1 outline-gray-100">
    <form action="">
        ...
        <div class="relative mb-2">
            ...
            <input type="password" id="password" name="username" placeholder="Enter your password" class="w-full px-2 pl-8 py-2 rounded-lg outline-none transition-all ease-in duration-300 bg-gray-100/50 focus:outline-none border-b-2 border-gray-200 focus:border-b-blue-500"/>
        </div>

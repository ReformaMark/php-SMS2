...
<section class="w-full sm:w-1/3 md:w-1/2 bg-white p-10 rounded-lg outline-1 outline-gray-100 shadow-xl">
    ...
    <form action="src/login.php" onsubmit="" method="post">
        ...
        <div class="relative mb-5 shadow-sm">
            ...
            <input type="text" name="username" placeholder="Enter your username" class="w-full px-2 pl-10 py-2 rounded-lg outline-none transition-all ease-in duration-300 bg-gray-100/50 focus:outline-none border-b-2 border-gray-200 focus:border-b-blue-500"/>
        </div>
        ...
        <div class="relative mb-2">
            ...
            <input type="password" id="password" name="password" placeholder="Enter your password" class="w-full px-2 pl-10 py-2 rounded-lg outline-none transition-all ease-in duration-300 bg-gray-100/50 focus:outline-none border-b-2 border-gray-200 focus:border-b-blue-500"/>
        </div>
    ...
    <h1 class="text-center text-sm text-gray-500">Don't have an account? <a href="#" class="text-blue-500">Register!</a></h1>
</section>
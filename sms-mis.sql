...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 01, 2025 at 10:56 AM
...
CREATE TABLE IF NOT EXISTS `attendance` (
  ...
  `date` date NOT NULL,
  `status` enum('Present','Absent','Late') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `departments` (
  ...
  `department_head` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `enrollments` (
  ...
  `current_status` enum('Enrolled','Completed','Dropped') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `financialtransactions` (
  ...
  `paid` int NOT NULL,
  `school_year` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `semester` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `studentTransactions` (`student_id`)
...
INSERT INTO `financialtransactions` (`id`, `student_id`, `amount`, `transaction_type`, `description`, `date`, `due_date`, `balance`, `paid`, `school_year`, `semester`) VALUES
(1, 's12345678', 2000, 'Charge', '', '2025-03-01', '2025-03-02', 0, 2000, '2024-2025', '1st'),
(2, 's12345678', 2000, 'Charge', '', '2025-03-01', '0000-00-00', 2000, 0, '2024-2025', '1st'),
(3, 's12345678', 2000, 'Charge', '', '2025-03-01', '0000-00-00', 2000, 0, '2024-2025', '2nd');
...
CREATE TABLE IF NOT EXISTS `grades` (
  ...
  `grade_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `amount` int NOT NULL,
  `date` date NOT NULL,
  `status` enum('On-Time','Late') COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `paymentTransactions` (`transaction_Id`),
  KEY `student_id` (`student_id`)
...
INSERT INTO `payments` (`id`, `student_id`, `transaction_Id`, `amount`, `date`, `status`) VALUES
(1, 's12345678', 1, 800, '2025-03-01', 'On-Time');
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  `status` enum('Active','Inactive','Graduated','On Leave') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `students` (`id`, `student_id`, `first_name`, `last_name`, `date_of_birth`, `created_at`, `gender`, `email`, `phone_number`, `address`, `enrollment_date`, `status`) VALUES
(1, 's12345676', 'John', 'Wick', '0000-00-00', '2024-10-11 06:45:10', '', 'john.wick.babayaga1@gmail.com', '09273658381', NULL, '2023-11-16', 'Active'),
(2, 's12345677', 'dasdasnion', 'nidosandoias', '2001-02-02', '2024-10-24 15:56:05', 'Male', 'ndsioandioas@gmail.com', '09173636251', NULL, '2024-10-18', 'Active'),
(3, 's12345678', 'Mark', 'Reforma', '2001-02-02', '2024-10-24 15:56:05', 'Male', 'markreforma1701@gmail.com', '09912458715', 'Blk 11 lot 6', '2024-10-18', 'Active');
...
(9, 's12345678', 'Mark', 'REFORMA', '2001-02-17', '2025-02-25 02:38:34', 'Male', '09913498714', 'asdasdsa\r\nasdasd\r\nasdasd', NULL, '$2y$12$iEM5Wmp7ETZBUyJceBUfROvGRjdWbiFonDJlOuzfQAb0YdBpQdIYS', 'Student', 'markreforma1701@gmail.com', 'Active', NULL, 0);
...
ALTER TABLE `financialtransactions`
  ADD CONSTRAINT `studentTransactions` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `paymentTransactions` FOREIGN KEY (`transaction_Id`) REFERENCES `financialtransactions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

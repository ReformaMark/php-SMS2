...
echo '<button id="coursesButton" aria-expanded="false" onclick="toggleAccordion()" class="px-3 cursor-pointer w-full flex justify-between items-center gap-x-3  transition-all duration-500 ease-linear font-normal text-lg border-b p-1">
...
echo '<a href="' . BASE_URL . '/src/layouts/student_ledger.php" class="block px-4 py-2 ' . $coursesClass . ' hover:bg-blue-500 hover:text-white">Student Ledger</a>';
echo '</div>';
echo '</div>';

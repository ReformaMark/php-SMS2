...
echo '<button id="coursesButton" aria-expanded="false" onclick="toggleAccordion()" class="cursor-pointer w-full flex justify-between items-center gap-x-3  transition-all duration-500 ease-linear font-normal text-lg border-b p-1">
